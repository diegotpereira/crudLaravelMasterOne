     ...
     <div id="app">
         <nav class="navbar navbar-expand-md navbar-ligth bg-white shadow-sm">
              <div class="container">
                   ...
                   <button class="navbar-toggler" type="button" data-toggle="collapse"  data-target="#navbarSupportedContent" aria-controls="navbarSuportedContent" aria-expanded="false"
